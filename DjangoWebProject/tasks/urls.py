...
urlpatterns = [
    ...
    path('category-details/<int:category_id>/', views.category_detail, name='category_detail',),
    path('category-details/<int:category_id>/delete/', views.delete_category, name='delete_category'),
    ]
